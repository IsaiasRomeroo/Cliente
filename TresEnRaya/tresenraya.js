...
function dibujaX(casilla){
	...
	function finPartida(){
		...
		if(estado[0]=='X' && estado[4]=='X' && estado[7]=='X'){
			fin=true;
		}
		if(estado[0]=='O' && estado[4]=='O' && estado[7]=='O'){
			fin=true;
		}
		if(estado[1]=='O' && estado[4]=='O' && estado[7]=='O'){
			fin=true;
		}
		if(estado[2]=='X' && estado[5]=='X' && estado[8]=='X'){
			fin=true;
		}
		if(estado[2]=='O' && estado[5]=='O' && estado[8]=='O'){
			fin=true;
		}
		...
		if(estado[6]=='X' && estado[7]=='X' && estado[8]=='X'){
			fin=true;
		}
		if(estado[6]=='O' && estado[7]=='O' && estado[8]=='O'){
			fin=true;
		}
			return fin;
