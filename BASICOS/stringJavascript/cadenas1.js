...
function buscarpalabra() {
	...
	let posicion = frase.IndexOf(buscarpalabra);

	if (frase!="" && buscar!="") {
		if(posicion == false)
			document.getElementById("salida1").innerHTML="esta en la posicion";
	}else{
		document.getElementById("salida1").innerHTML="no se encuentra";
	}
}